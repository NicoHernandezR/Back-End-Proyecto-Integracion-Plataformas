-- Antes de iniciar el servidor crear el schema, y despues ejecutar las sentencias sql INSERT
CREATE SCHEMA ferremas;

-- Seleccionar el schema recién creado para comenzar a usarlo
USE ferremas;
